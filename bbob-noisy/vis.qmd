...
format:
  html:
    include-after-body: 
      - text: <script type="text/javascript" defer src="../assets/bbob-noisy/js/bbob.js"></script>
---
...
<div class="wrapper">
  ...
  <div class="col3"><table BORDER="0" width=100%>
    ...
    <select id="fun" onchange="changePlot()" class="dropdown" style="width:220px;height:30px;"></select>
  ...
  <div class="col3"><table BORDER="0" width=100%>
    ...
    <select id="typ" onchange="changePlot()" style="width:220px;height:30px;"></select>
...
{{< include ../assets/bbob-noisy/md/plots.md >}}
