...
format:
  html:
    include-after-body: 
      - text: <script type="text/javascript" defer src="../assets/mixed-integer/js/bbob.js"></script>
---
...
<button id="dimPrev" onclick="getPrev(this)" class="button" hidden>&minus;</button>
<div id="dim" class="dropdown" disabled></div>
<button id="dimNext" onclick="getNext(this)" class="button" hidden>+</button>
</td>
<td class="select" align="center">
